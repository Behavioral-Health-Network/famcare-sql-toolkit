---
front-matter-title: ERE Enrolled No Referral
category: Exception Reports
source_file: code/exception-reports/ere-enrolled-no-referral.sql
...
# ERE Enrolled No Referral Exception Report

## Purpose

Identifies ERE enrollments that have no `PWEREREFERRAL` form entered and joined on `TIEDENROLLMENT`.
