---
front-matter-title: BCR Enrolled No Referral
category: Exception Reports
source_file: code/exception-reports/bcr-enrolled-no-referral.sql
...
# BCR Enrolled No Referral Exception Report

## Purpose

Identifies BCR enrollments that have no `PWBCRREFERRAL` form entered and joined on `TIEDENROLLMENT`.
