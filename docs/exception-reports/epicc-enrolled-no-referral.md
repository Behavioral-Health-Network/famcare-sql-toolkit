---
front-matter-title: EPICC Enrolled No Referral
category: Exception Reports
source_file: code/exception-reports/epicc-enrolled-no-referral.sql
...
# EPICC Enrolled No Referral Exception Report

## Purpose

Identifies EPICC enrollments that have no `PWEPICCREFERRAL` form entered and joined on `TIEDENROLLMENT`.
