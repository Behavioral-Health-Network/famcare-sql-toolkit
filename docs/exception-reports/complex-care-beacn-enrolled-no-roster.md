---
front-matter-title: Complex Care BEACN Enrolled No Roster
category: Exception Reports
source_file: code/exception-reports/complex-care-beacn-enrolled-no-roster.sql
...
# Complex Care BEACN Enrolled No Roster Exception Report

## Purpose

Identifies Complex Care BEACN enrollments that have no `PWCOMPLEXCAREROSTER` form entered and joined on `TIEDENROLLMENT`.
