...
**Source File:** `code/view-definitions/q-ere-client.sql`  
**Last Updated:** **2025-08-09**  
**Author:** BHN Data Team  

## Purpose

Provides a filtered client reference view for individuals enrolled in the ERE program.  
...
- **2025-07-02**: Initial creation to support ERE-specific client reporting.
